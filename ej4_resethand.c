...
int main(){
  ...
  // Con esto restaura el handler a como estaba por defecto despues de ejecutarse una vez.Por lo que en vez de ejecutar terminate , ejecutaria el por defecto.
